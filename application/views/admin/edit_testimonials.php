                        ...
                        <div class="card-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											<?php foreach($edit_testimonials as $r){?>
										    <form action="<?php echo base_url();?>admin/update_testimonials/<?php echo $r->id;?>" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">
													<div class="form-group row">
														<label class="control-label text-right col-md-3">Title</label>
														<div class="col-md-9">
															<input type="text" name="title" placeholder="title" value="<?php echo $r->title;?>" class="form-control" >
														</div>
													</div>
													<div class="form-group row">
