                        ...
                        <div class="card-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
										    <?php foreach($edit_blog->result() as $row){?>
											<form action="<?php echo base_url();?>admin/update_blog/<?php echo $row->blog_id;?>" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">
													<div class="form-group row">
														<label class="control-label text-right col-md-3">Blog Title</label>
														<div class="col-md-9">
															<input type="text" placeholder="Blog Title "  value="<?php echo $row->blog_title;?>" class="form-control" name="blog_title">
														</div>
													</div>
													<div class="form-group row">
													...
													<div class="form-group row">
														...
														<div class="col-md-9">
															<textarea  id="editor1" name="blog_desc"  required="" rows="5" cols="10" ><?php echo $row->blog_desc;?></textarea>
														</div>
													</div>
												</div>
