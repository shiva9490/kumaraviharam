    ...
    <div class="container-fluid">
        ...
        <div class="card-group">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form action="<?php echo base_url();?>admin/donation_report" class="col-md-12" method="POST" enctype="multipart/form-data">
							<div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
							...
							<a id="exportButton" class="btn btn-primary" target="_blank" href="<?php echo base_url();?>admin/donation_report_print">Print</a>
