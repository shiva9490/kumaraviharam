            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Event Imaages</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Event Imaages</li>
								<a class="btn btn-info d-none d-lg-block m-l-15" data-toggle="modal" data-target="#addModal">Add Images</a>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('event_imges');?></center>
									<center><span id="msg"></span></center>
									<?php if($event_imges > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($event_imges as $row){?>
												<tr id="old<?php echo $row->id;?>">	
													<td><?php echo $i;?></td>
													<td>
													<img width="100%" src="<?php echo base_url();?>assets/images/gallery/<?php echo $row->image;?>"></td>
													<td>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body">
					    <form action="<?php echo base_url();?>admin/add_event_images" method="POST" enctype="multipart/form-data">
					    	 <button type="button" class="close" data-dismiss="modal">&times;</button>
					    	 <label>Images</label>
					    	 <input type="file" class="form-control" name="relatedimages[]" multiple value="" placeholder="" required><br>
            ...
            function deletecatogry(id){
				...
				if(a == true){
					$.ajax({
						type: "POST",
						data: {'id':id},
						url : "<?php echo base_url();?>admin/delete_event_imges",
						dataType:"json",
		...
		<script>
			function inactive(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/inactive_event_imges",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
		...
		<script>
			function active(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/active_event_imges",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
