            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Event Video</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Event Video</li>
								<li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									...
									<center><?php echo $this->session->flashdata('addevent_video');?></center>
									<center><span id="msg"></span></center>
									<?php if(count($events_videos) > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i=1; foreach($events_videos as $row){?>
												<tr id="old<?php echo $row->id;?>">
													<td><?php echo $i;?></td>
													<td><iframe width="420" height="315" src="https://www.youtube.com/embed/<?php echo $row->video;?>"></iframe>
													</td>									
													<td>
									...
									<?php } else{?>
									<center>
										<button type="button" class="btn btn-info d-none d-lg-block m-l-15" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus-circle"></i> Add video </button>
									</center>
									<?php } ?>
								</div>
                            </div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-body">
					    <form action="<?php echo base_url();?>admin/addevent_video" method="POST" enctype="multipart/form-data">
            ...
            function deletecatogry(id){
				...
				if(a == true){
					$.ajax({
						type: "POST",
						data: {'id':id},
						url : "<?php echo base_url();?>admin/delete_event_video",
						dataType:"json",
		...
		<script>
			function inactive(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/inactive_event_video",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
		...
		<script>
			function active(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/active_event_video",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
