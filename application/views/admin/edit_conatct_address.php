                        ...
                        <div class="card-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
										    <?php foreach($edit_conatct_address as $row){?>
											<form action="<?php echo base_url();?>admin/update_conatct_address/<?php echo $row->id;?>" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">													
												...
												<div class="form-body">													
													<div class="form-group row">
														...
														<div class="col-md-9">
															<textarea style="width: 100%;" name="desc" id="editor1" required="" rows="8" col="5"><?php echo $row->desc;?></textarea>
														</div>
													</div>
												</div>
