            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">About Sthala Puranam</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">About Sthala Puranam</li>
                            </ol>
                            <a href="<?php echo base_url();?>admin/addsthalapuranam" class="btn btn-info d-none d-lg-block m-l-15" > Add Home Banner</a>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('sthalapuranam');?></center>
									<center><?php echo $this->session->flashdata('update_sthalapuranam');?></center>
									<center><span id="msg"></span></center>
									<?php if($sthalapuranam > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i=1; foreach($sthalapuranam as $row){?>
												<tr id="old<?php echo $row->id;?>">
													...
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_sthalapuranam/<?php echo $row->id;?>">Edit</a>
													</td>
													<td>
            ...
            function deletecatogry(id){
				...
				if(a == true){
					$.ajax({
						type: "POST",
						data: {'id':id},
						url : "<?php echo base_url();?>admin/delete_sthalapuranam",
						dataType:"json",
		...
		<script>
			function inactive(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/inactive_sthalapuranam",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
		...
		<script>
			function active(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/active_sthalapuranam",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
