            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Conatct Address</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Conatct Address</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									...
									<?php if(count($conatct_address) > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($conatct_address as $row){?>
												<tr id="old<?php echo $row->id;?>">	
													<td><?php echo $i;?></td>
													<td><?php echo $row->title;?></td>
													<td><?php echo $row->desc;?></td>									
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_conatct_address/<?php echo $row->id;?>">Edit</a>
													</td>
												</tr>		
												<?php  $i++; } ?>
											</tbody>
