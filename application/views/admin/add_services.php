            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add services</h4>
                    </div>
								...
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<form action="<?php echo base_url();?>admin/addservices" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">
													
													<div class="form-group row">
														<label class="control-label text-right col-md-3">Services Name</label>
														<div class="col-md-9">
															<input type="text" placeholder="Services Name"  id="ser_title" class="form-control" name="ser_title">
														</div>
													</div>
													<div class="form-group row">
													...
													<div class="form-group row">
														...
														<div class="col-md-9">
															<textarea  id="editor2" name="ser_desc"  required="" rows="5" cols="10" ></textarea>
														</div>
													</div>
												</div>
