                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="<?php echo base_url();?>admin/add_testimonials" class="btn btn-info d-none d-lg-block m-l-15"> Add Testimonials</a>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('add_testimonials');?></center>
									<center><?php echo $this->session->flashdata('testimonials');?></center>
									<center><span id="msg"></span></center>
									<?php if($testimonials > 0){?>
										...
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr id="old<?php echo $row->id;?>">
													...
													<td>
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_testimonials/<?php echo $row->id;?>">Edit</a>
													</td>
													<td>
		...
		<script>
			function inactive(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/inactive_testimonials",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
		...
		<script>
			function active(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/active_testimonials",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
