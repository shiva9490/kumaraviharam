                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('conatct_map');?></center>
									<center><span id="msg"></span></center>
									<?php if(count($conatct_map) > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($conatct_map as $row){?>
												<tr id="old<?php echo $row->id;?>">	
													<td><?php echo $i;?></td>										
													<td><?php echo $row->desc;?></td>
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_conatct_map/<?php echo $row->id;?>">Edit</a>
													</td>
												</tr>		
												<?php  $i++; } ?>
											</tbody>
