            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Home about us</h4>
                    </div>
                                ...
                                <div class="col-md-12">
									...
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($home_Sthala_Puranam as $row){?>
												<tr id="old<?php echo $row->id;?>">	
													<td><?php echo $i;?></td>									
													<td><img src="<?php echo base_url();?>assets/images/<?php echo $row->image;?>"></td>										
													<td><?php echo $row->desc;?></td>										
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_Sthala_Puranam/<?php echo $row->id;?>">Edit</a>
													</td>
												</tr>		
												<?php  $i++; } ?>
											</tbody>
