            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit concept evolution</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Edit concept evolution</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											<?php foreach($edit_concept_evolution as $r){?>
											<form action="<?php echo base_url();?>admin/update_concept_evolution/<?php echo $r->id;?>" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">
													...
													<div class="form-group row">
														...
														<div class="col-md-9">
															<input type="text" name="title" placeholder="" class="form-control" value="<?php echo $r->title;?>" required>
														</div>
													</div>
													<div class="form-group row">
														<label class="control-label text-right col-md-3">Desc</label>
														<div class="col-md-9">
															<textarea  id="editor1" name="desc"  required="" rows="5" cols="10" ><?php echo $r->desc;?></textarea>
														</div>
													</div>
												</div>
