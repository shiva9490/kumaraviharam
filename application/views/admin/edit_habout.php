								...
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<form action="<?php echo base_url();?>admin/update_habout/<?php echo $row->about_id;?>" method="POST" class="form-horizontal form-bordered" id="myForm" enctype="multipart/form-data">
												<div class="form-body">
												<div class="form-group row">
														<label class="control-label text-right col-md-3">About Desc</label>
														<div class="col-md-9">
															<textarea  id="editor1" name="about"  required="" rows="5" cols="10" ><?php echo $row->about;?></textarea>
														</div>
													</div>
												</div>
