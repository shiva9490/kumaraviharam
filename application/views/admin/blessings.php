            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Blessings List</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Blessings list</li>
                            </ol>
                            <a class="btn btn-info d-none d-lg-block m-l-15" href="<?php echo base_url();?>admin/addeventblessings"> Add blessings</a>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('blessings');?></center>
									<center><?php echo $this->session->flashdata('update_blessings');?></center>
									...
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i=1; foreach($blessings as $row){?>
												<tr id="old<?php echo $row->id;?>">
													<td><?php echo $i;?></td>
													<td><img src="<?php echo base_url();?>assets/images/<?php echo $row->image;?>"></td>
													...
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_blessings/<?php echo $row->id;?>">Edit</a>
													</td>
													<td>
            ...
            function deletecatogry(id){
				...
				if(a == true){
					$.ajax({
						type: "POST",
						data: {'id':id},
						url : "<?php echo base_url();?>admin/delete_blessings",
						dataType:"json",
		...
		<script>
			function inactive(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/inactive_blessings",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
		...
		<script>
			function active(id){
				$.ajax({
					type: "POST",
					data: {'id':id},
					url : "<?php echo base_url();?>admin/active_blessings",
					dataType:"json",
					success: function(data){
						var viewhtml ='';
						if(data.status > 0){
