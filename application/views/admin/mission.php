            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Mission & vision</h4>
                    </div>
                                ...
                                <div class="col-md-12">
									...
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($mission->result() as $row){?>
												<tr id="old<?php echo $row->mis_id;?>">	
													<td><?php echo $i;?></td>
													<td><?php echo $row->mission;?></td>										
													<td><?php echo $row->mission_descc;?></td>										
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_mission/<?php echo $row->mis_id;?>">Edit</a>
													</td>
												</tr>		
												<?php  $i++; } ?>
											</tbody>
