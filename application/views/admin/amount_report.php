            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Amount Report</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Amount Report</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <form action="<?php echo base_url();?>admin/amount_report" class="col-md-12" method="POST" enctype="multipart/form-data">
									<div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									...
									<a target="_blank" href="<?php echo base_url();?>admin/amount_report_print" class="btn btn-primary">Print</a>
									<div class="table-responsive m-t-40">
										<table id="example23" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i=1; foreach($amount_report as $row){?>
												<tr>
													<td>1</td>	
													<td>Below 10K</td>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		indexLabel: "{y}",
		dataPoints: [
		    <?php foreach($amount_report as $row){?>
			{y: <?php if($row->a) { echo $row->a; } else {echo  0.00 ;}?>, name: "Below 10"},
