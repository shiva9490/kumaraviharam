...
<head>
    ...
    <title>Myhairdo Admin Dashboard</title>    
    <!-- page css -->
...
<body class="skin-default card-no-border">
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Pugos admin</p>
        </div>
    </div>
                    ...
                    <div class="" style="background-image:url(<?php echo base_url();?>assets_admin/assets/images/background/login-register.jpg);">
                        <div class="login-box card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" method="post" action="<?php echo base_url('admin/changepassword/'.$id);?>">
            						<h3 class="text-center m-b-20">Change Password</h3>
                                    <div class="form-group ">
                                        <div class="col-xs-12">
                                            <input class="form-control" type="password" required="" name="oldpassword"  value="<?php echo $this->input->cookie('password');?>" placeholder="old password"> 
            							</div>
                                    </div>	
                                    <div class="form-group">
                                        <div class="col-xs-12">
