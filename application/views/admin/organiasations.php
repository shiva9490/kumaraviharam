<?php $data['a'] =  "Donations by Organiasations Report"; ?>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Donations by Organiasations Report</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Donations by Organiasations Report</li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <form action="<?php echo base_url();?>admin/organiasations" class="col-md-12" method="POST" enctype="multipart/form-data">
									<div class="row">
                                ...
                                <div class="col-md-12">
									...
									<div class="table-responsive m-t-40">
										<table id="example23" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i=1; foreach($organiasations as $row){?>
												<tr>
													<td><?php echo $i; ?></td>	
