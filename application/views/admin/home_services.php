            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Home Services</h4>
                    </div>
                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
									<center><?php echo $this->session->flashdata('update_hservices');?></center>
									<center><span id="msg"></span></center>
									<?php if($home_services > 0){?>
									<div class="table-responsive m-t-40">
										<table id="myTable" class="table table-bordered table-striped">
											...
											<tbody>
												<?php $i="1"; foreach($home_services as $row){?>
												<tr id="old<?php echo $row->id;?>">	
													<td><?php echo $i;?></td>
													<td><?php echo $row->services_name;?></td>										
													<td><?php echo $row->services_desc;?></td>										
													<td>													
														<a class="btn btn-warning shi" href="<?php echo base_url();?>admin/edit_hserives/<?php echo $row->id;?>">Edit</a>
													</td>
												</tr>		
												<?php  $i++; } ?>
											</tbody>
