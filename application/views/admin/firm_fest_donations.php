<?php $data['a'] =  " Firm Donations during festivals Report"; ?>
    ...
    <div class="container-fluid">
        ...
        <div class="card-group" >
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form action="<?php echo base_url();?>admin/firm_fest_donations" class="col-md-12" method="POST" enctype="multipart/form-data">
							<div class="row">
                ...
                <div class="card-body printableArea" id="tabs" >
                    <?php //$this->load->view('admin/print_css');?>
                    <div class="row">
                        <div class="col-md-12">
							<center><span id="msg"></span></center>
							<a target="_blank" class="btn btn-primary" href="<?php echo base_url();?>admin/firm_fest_donations_print">Print</a>
							<div class="table-responsive m-t-40">
								<table id="example23" class="table table-bordered table-striped table-hover">
									<thead>
										<th>S.No</th>
										<th>Festival</th>
